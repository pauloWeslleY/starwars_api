               ...
               <Col>
                  <Jumbotron>
                     ...
                     <div className="text-center">
                        <Button outline color="warning" onClick={toggle}>All Person</Button>
                     </div>
                     <hr className="my-2" />
                     <CardGroup>
                        <Card>
                           <CardBody>
                              ...
                              <CardSubtitle tag="h6" className="mb-2 text-muted">Height: { people1.height }</CardSubtitle>
                              <CardText>
                                 <List type="unstyled">
                                    <strong>Mass:</strong>
                                    <li>{people1.mass}</li>
                                    ...
                                    <li><Link to="/planets">{people1.homeworld}</Link></li>
                        ...
                        <Card>
                           <CardBody>
                              ...
                              <CardSubtitle tag="h6" className="mb-2 text-muted">Height: { people2.height }</CardSubtitle>
                              <CardText>
                                 <List type="unstyled">
                                    <strong>Mass: </strong>
                                    <li>{people2.mass}</li>
                                    ...
                                    <strong>HomeWorld:</strong>
                                    <li><Link to="/planets">{people2.homeworld}</Link></li>
                                    <strong>Created:</strong>
                        ...
                        <Card>
                           <CardBody>
                              ...
                              <CardSubtitle tag="h6" className="mb-2 text-muted">Height: { people3.height }</CardSubtitle>
                              <CardText>
                                 <List type="unstyled">
                                    <strong>Mass: </strong>
                                    <li>{people3.mass}</li>
                                    ...
                                    <strong>HomeWorld:</strong>
                                    <li><Link to="/planets">{people3.homeworld}</Link></li>
                                    <strong>Created:</strong>
                     ...
                     <CardGroup>
                        <Card>
                           <CardBody>
                              ...
                              <CardSubtitle tag="h6" className="mb-2 text-muted">Height: { people4.height }</CardSubtitle>
                              <CardText>
                                 <List type="unstyled">
                                    <strong>Mass:</strong>
                                    <li>{people4.mass}</li>
                                    ...
                                    <strong>HomeWorld:</strong>
                                    <li><Link to="/planets">{people4.homeworld}</Link></li>
                                    <strong>Created:</strong>
                        ...
                        <Card>
                           <CardBody>
                              ...
                              <CardSubtitle tag="h6" className="mb-2 text-muted">Height: { people5.height }</CardSubtitle>
                              <CardText>
                                 <List type="unstyled">
                                    <strong>Mass:</strong>
                                    <li>{people5.mass}</li>
                                    ...
                                    <strong>HomeWorld:</strong>
                                    <li><Link to="/planets">{people5.homeworld}</Link></li>
                                    <strong>Created:</strong>
                        ...
                        <Card>
                           <CardBody>
                              ...
                              <CardSubtitle tag="h6" className="mb-2 text-muted">Height: { people6.height }</CardSubtitle>
                              <CardText>
                                 <List type="unstyled">
                                    <strong>Mass:</strong>
                                    <li>{people6.mass}</li>
                                    ...
                                    <strong>HomeWorld:</strong>
                                    <li><Link to="/planets">{people6.homeworld}</Link></li>
                                    <strong>Created:</strong>
                     ...
                     <CardGroup>
                        <Card>
                           <CardBody>
                              ...
                              <CardSubtitle tag="h6" className="mb-2 text-muted">Height: { people7.height }</CardSubtitle>
                              <CardText>
                                 <List type="unstyled">
                                    <strong>Mass:</strong>
                                    <li>{people7.mass}</li>
                                    ...
                                    <strong>HomeWorld:</strong>
                                    <li><Link to="/planets">{people7.homeworld}</Link></li>
                                    <strong>Created:</strong>
                        ...
                        <Card>
                           <CardBody>
                              ...
                              <CardSubtitle tag="h6" className="mb-2 text-muted">Height: { people8.height }</CardSubtitle>
                              <CardText>
                                 <List type="unstyled">
                                    <strong>Mass:</strong>
                                    <li>{people8.mass}</li>
                                    ...
                                    <strong>HomeWorld:</strong>
                                    <li><Link to="/planets">{people8.homeworld}</Link></li>
                                    <strong>Created:</strong>
                        ...
                        <Card>
                           <CardBody>
                              ...
                              <CardSubtitle tag="h6" className="mb-2 text-muted">Height: { people9.height }</CardSubtitle>
                              <CardText>
                                 <List type="unstyled">
                                    <strong>Mass:</strong>
                                    <li>{people9.mass}</li>
                                    ...
                                    <strong>HomeWorld:</strong>
                                    <li><Link to="/planets">{people9.homeworld}</Link></li>
                                    <strong>Created:</strong>
                  ...
                  <Modal isOpen={modal} toggle={toggle} className={className}>
                     ...
                     <ModalBody>
                        <div>
                           {person.map((value, i) => {
                              return (
                                 <h3 className="text-center" key={i}>{ value.name }</h3>
                              )
                           })}
                     ...
                     <ModalFooter>
                        <Button outline color="warning" onClick={toggle}>Sair</Button>{' '}
                     </ModalFooter>
                  </Modal>
               </Col>
            </Row>
