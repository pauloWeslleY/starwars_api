												...
												<Card body className="text-center">
													...
													<CardText>
														<List type="unstyled">
															...
															<li>
																{
																	vehicles2.max_atmosphering_speed
																}
															</li>
															<strong>Length:</strong>
												...
												<Card body className="text-center">
													...
													<CardText>
														<List type="unstyled">
															...
															<li>
																{
																	vehicles3.max_atmosphering_speed
																}
															</li>
															<strong>Length:</strong>
												...
												<Card body className="text-center">
													...
													<CardText>
														<List type="unstyled">
															...
															<li>
																{
																	vehicles4.max_atmosphering_speed
																}
															</li>
															<strong>Length:</strong>
